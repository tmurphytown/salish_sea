  ...
  return (
    <main>
      <div className="flex flex-col items-center justify-center bg-white h-screen relative" id="home">
        ...
        <div className="bg-white bg-opacity-30 backdrop-blur-md rounded drop-shadow-lg m-auto p-auto w-1/2 h-2/3 items-center justify-center relative z-10">
      ...
      <div className="flex flex-col items-center bg-c1 h-2xscreen relative" id="section1">
        ...
        <Link href="#home" type="submit" className="bg-opacity-75 bg-blur-lg hover:bg-opacity-100 bg-c1 text-c3 border border-c3 drop-shadow-lg hover:bg-c3 hover:text-white hover:border-c2 hover:font-extrabold px-4 py-2 mb-24 mt-10 rounded-md">back</Link>
      </div>
